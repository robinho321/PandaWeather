...
let albumName4 = "Panda - Rain Weather"            //App specific folder name

class RainCVC: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell{
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as? rainCell
    ...
    override func setEditing(_ editing: Bool, animated: Bool) {
        ...
        if let indexPaths = collectionView?.indexPathsForVisibleItems {
            for indexPath in indexPaths {
                if let cell = collectionView?.cellForItem(at: indexPath) as? rainCell {
...
extension RainCVC: rainCellDelegate
{
    func delete(cell: rainCell) {
