...
let albumName = "Nice Weather"            //App specific folder name
...
//        picker.mediaTypes = UIImagePickerController.availableMediaTypes(for: .photoLibrary)!
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell{
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as? niceCell
    ...
    override func setEditing(_ editing: Bool, animated: Bool) {
        ...
        if let indexPaths = collectionView?.indexPathsForVisibleItems {
            for indexPath in indexPaths {
                if let cell = collectionView?.cellForItem(at: indexPath) as? niceCell {
...
extension NiceCVC: niceCellDelegate
{
    func delete(cell: niceCell) {
